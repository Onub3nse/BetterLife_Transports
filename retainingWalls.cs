...
namespace BetterLife.RoadsAndSigns
{
    internal class retainingWalls : IModData
    {
        public void RegisterData(ProtoRegistrator registrator)
        {
            ...
            RetainingWallProto wall1aOneBlock = CreateWall(registrator, BetterLIDs.Walls.WallA1Block, "Retaining Wall Type A", BetterLIDs.ToolBars.WallA,
                BLCosts.Walls.Wall1, 2, 1, vertLayoutWall1AOneBlock, BetterLIDs.dPath.wall1type1);

            RetainingWallProto wall1aCross = CreateWall(registrator, BetterLIDs.Walls.WallA1Cross, "Retaining Wall Cross Type A", BetterLIDs.ToolBars.WallA,
                BLCosts.Walls.Wall1, 2, 0, vertLayoutWall1Cross, BetterLIDs.dPath.wall1crosstype1);

            RetainingWallProto wall1aTee = CreateWall(registrator, BetterLIDs.Walls.WallA1Tee, "Retaining Wall Tee Type A", BetterLIDs.ToolBars.WallA,
                BLCosts.Walls.Wall1, 2, 0, vertLayoutWall1Tee, BetterLIDs.dPath.wall1teetype1);

            RetainingWallProto wall1aCorner = CreateWall(registrator, BetterLIDs.Walls.SeaWall1Corner, "Retaining Wall Corner Type A", BetterLIDs.ToolBars.WallA,
                BLCosts.Walls.Wall1, 2, 0, vertLayoutWall1Corner, BetterLIDs.dPath.wall1cornertype1);
